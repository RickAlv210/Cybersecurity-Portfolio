...
![IAM Dashboard showing the "Add MFA for root user" security recommendation before remediation](screenshots/01-iam-dashboard-before-mfa.png.png)
*IAM Dashboard before remediation — root MFA not yet enabled*

![Security Credentials page confirming the virtual MFA device is active](screenshots/02-root-mfa-enabled.png.png)
*Root MFA successfully enabled*
...
![All three groups with initial broad policies attached](screenshots/03-groups-created-baseline-policies.png.png)
*Developer, Finance, and Admins groups with baseline broad policies*

![All three users created and assigned to their groups](screenshots/04-users-created-and-grouped.png.png)
*alice-dev, bob-finance, and carlos-admin created and grouped*
...
![Developer group showing only the custom scoped policy, with ReadOnlyAccess removed](screenshots/05-developer-group-least-privilege-applied.png.png)
*Developer group after the least-privilege redesign — ReadOnlyAccess removed*
...
![Trust relationship confirming only ec2.amazonaws.com can assume this role](screenshots/06-ec2-role-trust-policy.png.png)
*EC2-S3-ReadWrite-Role trust policy restricting assumption to the EC2 service*
...
![Newly issued key showing "Last used: None"](screenshots/07-access-key-active-unused.png.png)
*Access key issued to carlos-admin, unused since creation*

![Confirmation of zero active access keys after cleanup](screenshots/08-access-key-deleted.png.png)
*Access key deactivated and deleted*
...
*Finding resolved after removing the public bucket policy*
...
![CloudTrail event history showing all PutBucketPolicy calls with timestamps](screenshots/11-cloudtrail-putbucketpolicy-events.png.png)
*CloudTrail confirming every bucket policy change is logged and auditable*
