...
![Enabling API](./screenshots/Enabling_API.png)

Confirmed the API was active and ready to use.

![Enabled API](./screenshots/Enabled_API.png)

Opened Cloud Shell and confirmed the correct project context before writing any code.

![Cloud Shell project context](./screenshots/Powershell_script.png)

Installed the official Python client library for DLP.

![DLP library installed](./screenshots/Google_DLP_Installed.png)
...
![Lowered threshold, still no SSN](./screenshots/rerun%20with%20changes.png)
...
![SSN successfully detected with a valid number](./screenshots/Rerun_with_working_changes_for_SSN.png)
...
![Fake CSV created](./screenshots/Fake_File_made.png)

**Uploaded the file to the bucket** and verified it landed correctly.

![File uploaded and verified](./screenshots/File%20uploaded%20and%20present.png)

**Installed the Cloud Storage Python client library** to allow the script to read files directly from the bucket.

![Cloud Storage library confirmed](./screenshots/File_uploaded__confirmed__and_uploaded_to_client.png)
...
![Bucket-based scan results](./screenshots/DLP_ran_on_bucket.png)
